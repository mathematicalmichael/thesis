...
\usepackage{etoolbox}
\AtBeginEnvironment{figure}{\setlength{\RaggedRightParindent}{0in}}
\AtBeginEnvironment{table}{\setlength{\RaggedRightParindent}{0in}}
\AtBeginEnvironment{algorithm}{\setlength{\RaggedRightParindent}{0in}}
