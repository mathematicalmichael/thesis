...
When solutions are given by densities, we form a family of conditional densities using an initial density to do this.
...
However, unlike the density-based approach that utilizes the pushforward of an initial density in the construction of a solution, the ansatz is imposed only on contours.
