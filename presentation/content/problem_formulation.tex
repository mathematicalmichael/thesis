...
d_{\text{TV}} (\updatedP, \widehat{\updatedP}) \leq C d_{\text{TV}} (\updatedP, \widehat{\updatedP}),
\end{equation}
...
\begin{itemize}
	...
	\item Accuracy of the computed updated density relies on the accuracy of the approximation of the push-forward of the initial
