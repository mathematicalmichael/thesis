...
The density $\partial \dataP / \partial \mu_D$ characterizing the pushforward measure $\dataP$ is referred to as the \emph{predicted} distribution $\predicted$, and is given by the Radon-Nikodym derivative with respect to (the Lebesgue) volume measure $\mu_D$ on ${(\dspace, \dborel)}$
