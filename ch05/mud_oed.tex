...
\centering
  ...
  \includegraphics[width=0.475\linewidth]{figures/pde/pde_qoi_response}
...
\centering
  ...
  \includegraphics[width=0.475\linewidth]{figures/pde/pde-alt_qoi_response}
  ...
  As a result of these choices, we observe less measurements near zero (rightmost histogram), and slopes with larger magnitude (center).
  }
