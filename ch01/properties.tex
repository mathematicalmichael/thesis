...
\end{equation} 
is a consistent solution to the stochastic inverse problem given in (\ref{eq:inv}), and is uniquely defined up to the specification of a prior probability measure $P_\pspace$ on $(\pspace, \pborel)$.
\end{thm}
