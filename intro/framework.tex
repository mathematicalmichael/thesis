...
In measure-theoretic terms, $\PP_\dspace$ in Definition~\ref{def:forward-problem} is a push-forward measure of $\PP_\pspace$, and in Definition~\ref{def:inverse-problem}, $\PP_\pspace$ is a pull-back measure of $\PP_\dspace$.
